...
const ISLANDS = ['FanGrid client:visible', 'FanbaseIndex client:visible', 'Games client:visible', 'Leaderboard client:load', 'PlayerSearch client:idle', 'Receipts client:load']
